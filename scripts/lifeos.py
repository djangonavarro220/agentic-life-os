...
SEMANTIC_QUESTIONS: list[dict[str, Any]] = [
    {
        ...
        "inspect_before_asking": "No runtime discovery required; ask the user to choose the install-wide autonomy policy.",
    ...
    },
    {
        ...
        "inspect_before_asking": "Inspect runtime task tools, task ledgers, TODO integrations, and existing follow-up stores before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect runtime memory, profile/context files, notes/canonical sources, and memory write policy before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect runtime scheduling and cron capabilities plus existing routine jobs before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect existing daily briefing, pulse, morning/evening summary, and scheduled synthesis routines before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect existing heartbeat, watcher, cron, standing-order, and no-news/silent policies before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect existing daily, weekly, monthly, quarterly, and system-review routines or reminders before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect runtime cron jobs, review meeting schedules, delivery routes, and disabled/manual opt-outs before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect existing skill-maintenance, self-improvement, retrospective, backlog, and repo-health routines before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect runtime delivery routes, channels, topics, aliases, and existing routine destinations before asking.",
    ...
    },
    {
        ...
        "requires_runtime_discovery": True,
        "inspect_before_asking": "Inspect runtime cron output history, run records, logs, and routine archives before asking.",
...
def setup_decision_payload(question: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "requires_runtime_discovery": question.get("requires_runtime_discovery", False),
        "inspect_before_asking": question.get("inspect_before_asking", ""),
