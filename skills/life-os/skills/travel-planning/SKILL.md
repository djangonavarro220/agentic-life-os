...
description: Plan travel logistics, reservations, packing, documents, itinerary risks, and follow-up actions.
version: 0.1.0
...
8. Record useful Life OS coordination state under `$LIFEOS_DATA_DIR/travel-planning/data.json` when the user/runtime policy allows it.
...
```text
$LIFEOS_DATA_DIR/travel-planning/data.json
```
