...
description: Track document, identity, permit, contract, insurance, domain, and certificate renewals with safe lead times.
version: 0.1.0
...
8. Record useful Life OS coordination state under `$LIFEOS_DATA_DIR/documents-renewals/data.json` when the user/runtime policy allows it.
