---
name: work-portfolio
description: Maintain a professional portfolio, achievement log, interview material, opportunities, and career evidence.
version: 0.1.0
...
Maintain professional evidence and opportunity material: achievements, projects, portfolio entries, interview stories, role targets, references, and follow-up actions.

## Trigger

Use when the user asks to:

- capture professional achievements, project outcomes, or metrics
- prepare CV, portfolio, interview, or promotion material
- track opportunities, applications, recruiter conversations, or networking follow-ups
- review career direction and evidence gaps
- turn work history into concise reusable stories
...
8. Record useful Life OS coordination state under `$LIFEOS_DATA_DIR/work-portfolio/data.json` when the user/runtime policy allows it.

## Source decision

Store the source choice in `$LIFEOS_DATA_DIR/work-portfolio/data.json` when useful:

```json
{
  "source_decisions": {
    "work_portfolio_records": {
...
```text
$LIFEOS_DATA_DIR/work-portfolio/data.json
```
