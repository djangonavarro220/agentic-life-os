---
name: finance-checkup
description: Review personal finance signals, recurring costs, renewals, savings goals, and anomalies without becoming the bank of record.
version: 0.1.0
...
8. Record useful Life OS coordination state under `$LIFEOS_DATA_DIR/finance-checkup/data.json` when the user/runtime policy allows it.
...
```text
$LIFEOS_DATA_DIR/finance-checkup/data.json
```
